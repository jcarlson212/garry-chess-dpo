...
def process_split(
    ...
    *,
    ...
    out_path = pgn_path.parent / f"{gm_name}_dpo.jsonl"
    ...
    print(f"Wrote {n} preference pairs -> {out_path}")


def main():
    # Example usage: python ./src/grandmaster_dpo/data_processing/single_gm/famous_chessgames_gms/z_curate_dpo.py --gm_name alekhine
    ...
    args = ap.parse_args()
    pgn_path = Path(f"./processed/single_gm/famous_chessgames_gms/{args.gm_name}.pgn")

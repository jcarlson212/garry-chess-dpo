...
def main() -> None:
    # Example usage: python ./src/grandmaster_dpo/train/single_gm/famous_chessgames_gms/train_dpo_maia2.py --gm_name alekhine
    ...
    train_jsonl = Path(f"./processed/single_gm/famous_chessgames_gms/{args.gm_name}_dpo.jsonl")
    out_dir = Path(f"./processed/single_gm/famous_chessgames_gms/{args.gm_name}")

...
```sh
for gm in carlsen nakamura firouzja caruana wei vincent giri gukesh praggnanandhaa; do python ./src/grandmaster_dpo/eval/single_gm/stockfish_tree_search/eval_all_types_in_one.py --gm_name $gm --split val --sf_depth 12,14 --sf_tops 10; done
```
